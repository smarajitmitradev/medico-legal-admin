    ...
    <script>
        ...
        function CustomChartPlugin(editor) {
            ...
            conversion.for("upcast").elementToElement({
                ...
                model: (viewElement, {
                    ...
                    return writer.createElement("chart", {
                        dataChart
                    });
                }
            });
            ...
            conversion.for("editingDowncast").elementToElement({
                ...
                view: (modelItem, {
                    ...
                    // Create raw DOM element for Chart.js
                    ...
                    try {
                        const config = JSON.parse(decodeURIComponent(dataChart));
                    ...
                    const widget = writer.createRawElement("div", {}, function(domElementWrapper) {
                        domElementWrapper.appendChild(domElement);
                    });

                    writer.insert(writer.createPositionAt(div, 0), widget);
        ...
        function insertGraph() {
            ...
            editor.model.change(writer => {
                const chartElement = writer.createElement("chart", {
                    dataChart
                });
