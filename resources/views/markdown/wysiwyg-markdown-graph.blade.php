...
<body>
    ...
    function insertGraph() {
        ...
        const html = `<div class="chart" data-chart='${encodeURIComponent(JSON.stringify(chartData))}'></div><p><br></p>`;
...
function renderAll() {
    ...
    if (ww) renderCharts(ww);

    // ✅ Markdown preview (delayed)
    const md = document.querySelector('.toastui-editor-md-preview');
    if (md) {
        setTimeout(() => {
            renderCharts(md);
        }, 300);
    ...
    // ✅ Detect preview tab click (IMPORTANT)
